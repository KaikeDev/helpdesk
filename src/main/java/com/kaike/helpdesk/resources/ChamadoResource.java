...
public class ChamadoResource {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<ChamadoDTO> updateChamado(@PathVariable Integer id,@Valid @RequestBody ChamadoDTO novoChamado){
		Chamado newObj = chamadoService.update(id, novoChamado);
