...
public class DBService {
	...
	public void instanciaDB() {
		...
		Cliente cli1 = new Cliente(null, "Luysa", "987654321", "luysa@gmail.com", encoder.encode("321"));
		...
		Chamado c1 = new Chamado(null, Prioridade.MÉDIA, StatusEnum.ANDAMENTO, "Chamado 01", "Primeiro chamado", tec1,
				cli1);
		
		Chamado c2 = new Chamado(null, Prioridade.ALTA, StatusEnum.ABERTO, "Chamado 2", "Teste chamado 2", tec1, cli2);
		Chamado c3 = new Chamado(null, Prioridade.BAIXA, StatusEnum.ENCERRADO, "Chamado 3", "Teste chamado 3", tec2, cli3);
		Chamado c4 = new Chamado(null, Prioridade.ALTA, StatusEnum.ABERTO, "Chamado 4", "Teste chamado 4", tec3, cli3);
		Chamado c5 = new Chamado(null, Prioridade.MÉDIA, StatusEnum.ANDAMENTO, "Chamado 5", "Teste chamado 5", tec2, cli1);
		Chamado c6 = new Chamado(null, Prioridade.BAIXA, StatusEnum.ENCERRADO, "Chamado 7", "Teste chamado 6", tec1, cli5);
